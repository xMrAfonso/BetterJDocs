...
If you want to check out a live demonstration, you may check [Hangar4J's JavaDocs](https://google.com).

## How to install
1. Download the [stylesheet from GitHub](https://google.com). (`betterjdocs.css`)
